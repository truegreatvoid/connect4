...
def mcts(board, player, simulations=VALOR_SIMULACAO):
...
def play_game_mcts_vs_mcts(simulations=VALOR_SIMULACAO):
    board = create_board()
    game_over = False
    turn = 0
    ...
    while not game_over:
        if turn == 0:
            ...
            if col is not None and is_valid_location(board, col):
                ...
                print_board(board)  # Imprime o tabuleiro após a jogada do Jogador 1
            ...
            if col is not None and is_valid_location(board, col):
                ...
                print_board(board)  # Imprime o tabuleiro após a jogada do Jogador 2
...
play_game_mcts_vs_mcts(simulations=VALOR_SIMULACAO)
end_time = time.time()
