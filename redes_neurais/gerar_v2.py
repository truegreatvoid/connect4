...
def simulate_game():
    ...
    while not game_over:
        ...
        col = choose_move(board, current_player)
...
def choose_move(board, piece):
    ...
    # 4. Escolher aleatoriamente entre as jogadas restantes
...
if __name__ == "__main__":
    ...
    ARQUIVO_SAIDA = 'saida/csv/connect4_data.csv'
