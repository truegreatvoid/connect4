...
checkpoint = ModelCheckpoint(
    os.path.join(MODEL_DIR, 'best_model_v4.keras'), monitor='val_accuracy',
...
model.save(os.path.join(MODEL_DIR, 'connect4_model_v4_final.keras'))
print("Modelo treinado e salvo como 'connect4_model_v4_final.keras'")

# Gerar a representação visual do modelo
plot_model(
    model,
    to_file=os.path.join(MODEL_DIR, 'modelo_convolucional_v4.png'),
    show_shapes=True,
...
print("Imagem do modelo gerada e salva como 'modelo_convolucional_v4.png' na pasta 'models'.")
...
plt.savefig(os.path.join(MODEL_DIR, 'training_history_v4.png'))
plt.show()
